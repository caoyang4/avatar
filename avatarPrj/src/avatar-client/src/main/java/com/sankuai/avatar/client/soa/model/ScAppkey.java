...
public class ScAppkey {
     ...
     * 速率限制合格
     */
    private Boolean rateLimitQualified;

    /**
     * 文档SOA文档
     */
    private Boolean documentQualified;

    /**
     * 存储合格
     */
    private Boolean storageQualified;

    /**
     * 认证合格
     */
    private Boolean authQualified;
     ...
     * 子结算单元id
     */
    private Integer subBillingUnitId;

    /**
     * 是需要速率限制
     */
    private Boolean isNeedRateLimit;
