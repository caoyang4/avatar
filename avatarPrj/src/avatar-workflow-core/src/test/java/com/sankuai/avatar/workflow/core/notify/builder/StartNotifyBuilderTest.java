...
public class StartNotifyBuilderTest {
    @Spy
    private TemplateParser templateParser;

    @InjectMocks
    private StartNotifyBuilder startNotifyBuilder;


    @Before
    public void setUp() {
        templateParser.init();
        ReflectionTestUtils.setField(startNotifyBuilder, "avatarDomain", "test.com");
    }
    ...
    public void testBuild() {
        ...
        List<NotifyResult> notifyResultList = startNotifyBuilder.build(notifyRequest);
