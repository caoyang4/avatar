...
public class ScNotBackendAppkeyDataCollectorTest {
    ...
    private ScNotBackendAppkeyDataCollector scNotBackendAppkeyDataCollectorUnderTest;

    private CollectEvent collectEventData = null;

    @Before
    public void setUp() throws Exception {
        scNotBackendAppkeyDataCollectorUnderTest = new ScNotBackendAppkeyDataCollector(mockAppkeyResource, applicationResource, cacheClient);
    ...
    public void testCollect() {
        ...
        // Run the test
        final AppkeyCollectEventResult result = scNotBackendAppkeyDataCollectorUnderTest.collect(collectEventData);
    ...
    public void testCollect_AppkeyResourceGetAppkeyByScV2ThrowsSdkCallException() {
        ...
        // Run the test
        assertThatThrownBy(() -> scNotBackendAppkeyDataCollectorUnderTest.collect(collectEventData))
